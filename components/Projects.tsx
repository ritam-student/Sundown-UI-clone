...
export default function Projects() {
    ...
    return <div className="h-auto  w-full px-4 sm:px-6 md:px-8 lg:px-10  py-15 ">
        ...
        <div className="h-[105vh] w-full bg-black rounded-3xl mt-15 flex flex-col md:flex-row items-center justify-between gap-4 ">
            <div className="md:w-1/2 w-full h-full px-4 md:px-10 rounded-3xl flex items-center justify-center">
            ...
            <div className="md:w-1/2 w-full h-full   p-2 md:p-0 rounded-3xl object-cover object-center overflow-hidden">
                {
                    iteration === 0 ?
